                ...
                ElevatedButton(
                  onPressed: _isUploading
                      ...
                      : () async {
                          ...
                          try {
                            final resp = await ApiService.createProperty(
                              title: titleController.text,
                              price: priceController.text,
                              oldPrice: oldPriceController.text.isEmpty
                                  ? null
                                  : oldPriceController.text,
                              delivery: deliveryController.text.isEmpty
                                  ? null
                            ...
                            if (resp.containsKey('success') && resp['success'] == false) {
                              ScaffoldMessenger.of(context).showSnackBar(
