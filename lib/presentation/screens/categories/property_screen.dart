...
class _MyPropertyState extends State<MyProperty> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (property["ownerName"] != null &&
                        property["ownerName"].toString().isNotEmpty)
                      Padding(
  ...
  void _showRequestDialog(Map<String, dynamic> property) {
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('Owner: ${property["ownerName"] ?? "Unknown"}'),
            const SizedBox(height: 16),
            TextField(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              Navigator.pop(context);
              await _sendRequest(property, messageController.text);
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: Colors.blue,
              foregroundColor: Colors.white,
